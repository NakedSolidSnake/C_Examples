...
int main(void)
{
  ...
  if(curl) {
    ...
    curl_easy_setopt(curl, CURLOPT_USERNAME, "cristianogame@gmail.com");
    curl_easy_setopt(curl, CURLOPT_PASSWORD, "$0l1d$2r2");
 
    curl_easy_setopt(curl, CURLOPT_URL, "smtp://smtp.gmail.com:465");
 
    curl_easy_setopt(curl, CURLOPT_USE_SSL, (long)CURLUSESSL_ALL);
 
    curl_easy_setopt(curl, CURLOPT_CAINFO, "/home/cssouza/Desktop/Wiki/cert.pem");
