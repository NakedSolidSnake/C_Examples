...
void *program_a(void *args)
{
    ...
    while(1){
        ...
        if(update){
            ...
            mem->processes[0].update = (time_t)((double)current.tv_sec + (double)current.tv_nsec/(double)1000000000);
            update = 0;
            alarm(1);
        }
